...
/**
 * Calls TypeSafe System One (Jev) via local proxy to decide the next enemy action.
 * Adheres to the TypeSafe skill guidelines: structured state, clear criteria, and backticked path references.
...
export class JevDecisionProvider implements DecisionProvider {
  ...
  constructor() {
    ...
    if (!apiKey) throw new Error('VITE_TYPESAFE_API_KEY is not set in .env');
